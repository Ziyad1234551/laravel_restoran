...
<div class="w-full  h-[70vh] flex justify-center items-center">
    <form action="{{url("createMakanan")}}" method="POST" enctype="multipart/form-data"  class="lg:w-[600px] w-[100px] bg-white shadow-xl px-8 rounded-lg py-4">
